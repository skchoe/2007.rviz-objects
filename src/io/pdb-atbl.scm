(module pdb-atbl mzscheme
(require (lib "etc.ss"))

(provide atom-no-tbl atom-name-tbl atom-symbol-tbl)
...
(define atom-no-tbl 
  #hash(
        ...
        ("Mt" . 109) ("Ds" . 110) ("Rg" . 111)
        ("Uub" . 112) ("Uut" . 113) ("Uuq" . 114)
        ("Uup" . 115) ("Uuh" . 116) ("Uus" . 117)
        ("Uuo" . 118)))
  
; Atom Number - Symbol
(define atom-symbol-tbl 
  #hash(
        (1 . "H") (2 . "He") (3 . "Li")
        (4 . "Be") (5 . "B") (6 . "C")
        (7 . "N") (8 . "O") (9 . "F")
        ...
        (112 . "Uub") (113 . "Uut") (114 . "Uuq")
        (115 . "Uup") (116 . "Uuh") (117 . "Uus")
        (118 . "Uuo")))
  
; atomic names from http://www.webelements.com - Priya 12/28/06
; Atom Number - Name
(define atom-name-tbl 
  #hash(
	...
	(4 . "Beryllium") (5 . "Boron") (6 . "Carbon")
        ...
        (46 . "Paladium") (47 . "Silver") (48 . "Cadmium")
        ...
        (64 . "Gadolinium") (65 . "Terbium") (66 . "Dyprosium")
        ...
        (112 . "Ununbium") (113 . "Ununtrium") (114 . "Ununquadium")
        (115 . "Ununpentium") (116 . "Ununhexium") (117 . "Ununseptium")
        (118 . "Ununoctium"))))
